import { DuaaTimeProps } from './DuaaTime';

export const duaaTimesData: DuaaTimeProps[] = [
  {
    number: 1,
    ...
    reference: 'https://sunnah.com/bukhari:1145'
  },
  {
    number: 2,
    ...
    reference: 'https://sunnah.com/abudawud:521'
  },
  {
    number: 3,
    title: 'During Sujood',
    ...
    englishText: 'The nearest a servant comes to his Lord is when he is prostrating himself, so make supplication (in this state).',
    reference: 'https://sunnah.com/muslim:482'
  },
  {
    number: 4,
  ...
  },
  {
    ...
    reference: 'https://sunnah.com/abudawud:1048'
  },
  {
    number: 8,
    ...
    englishText: 'The supplication that a Muslim makes for his brother in his absence is answered. At his head is an angel assigned, and whenever he supplicates for his brother with something good, the angel assigned to him says: "Ameen, and may you have likewise."',
    reference: 'https://sunnah.com/muslim:2732'
  },
  {
    number: 9,
  ...
  },
  {
    ...
    englishText: 'None has the right to be worshipped but You (O Allah), Glorified (and Exalted) are You. Truly, I have been of the wrongdoers.',
    reference: 'https://sunnah.com/tirmidhi:3505'
  },
  {
    number: 15,
    ...
    englishText: 'Fear the supplication of the oppressed, for there is no barrier between it and Allah.',
    reference: 'https://sunnah.com/bukhari:2448'
  }
];
